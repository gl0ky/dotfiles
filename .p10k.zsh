# Generated by Powerlevel10k configuration wizard on 2022-04-21 at 15:09 -04.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    dir
    background_jobs                     # current directory
    direnv
    virtualenv
...
#    context                 # user@hostname
  ...
  #typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION='%B%n@%m'
